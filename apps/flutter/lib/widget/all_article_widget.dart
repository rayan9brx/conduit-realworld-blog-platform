      ...
      child: Card(
        ...
        child: Column(
          ...
          children: [
            ...
            // In diesem Bereich wird der Artikeltext als Markdown angezeigt, um eine formatierte Darstellung zu ermöglichen
            Padding(
              padding: const EdgeInsets.only(top: 5, left: 10, right: 10),
              child: Container(
                
                // Die maximale Höhe des Markdown-Bereichs wird begrenzt, damit die Karten in der Übersicht nicht zu groß werden
                constraints: BoxConstraints(
                  maxHeight: 100,
                ),
                child: SingleChildScrollView(
                  
                  // Die MarkdownBody-Komponente rendert den Artikelinhalt mit Markdown-Formatierung
                  child: MarkdownBody(
                    data: widget.articlesModel?.body ?? '',
                    
                    // Der imageBuilder ermöglicht es, Bilder innerhalb des Artikels korrekt darzustellen
                    imageBuilder: (uri, title, alt) {
                      
                      // Bilder werden aus dem Netzwerk geladen und mit einer festen Höhe dargestellt
                      return Image.network(
                        uri.toString(),
                        fit: BoxFit.contain,
                        height: 200,

                        // Falls ein Bild nicht geladen werden kann, wird text angezeigt
                        errorBuilder: (ctx, error, stack) => const Text("[Image failed to load]"),
                      );
                    },
                  ),
                ),
