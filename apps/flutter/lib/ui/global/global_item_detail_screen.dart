                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(
                                        ...
                                        child: SingleChildScrollView(
                                          ...
                                          // Die MarkdownBody-Komponente wird verwendet, um den Artikeltext formatiert darzustellen
                                            child: MarkdownBody(
                                              
                                              // Der Artikeltext wird aus dem geladenen Artikelmodell übernommen
                                              data: state.articleModel.last.article?.body ?? '',
                                              
                                              // Der imageBuilder ermöglicht die Anzeige von Bildern, die im Artikeltext referenziert sind
                                              imageBuilder: (uri, title, alt) {
                                                
                                                // Die Bilder werden aus der angegebenen URL geladen und mit einer festen Höhe angezeigt
                                                return Image.network(
                                                  uri.toString(),
                                                  fit: BoxFit.contain,
                                                  height: 200,
                                                  
                                                  // Falls das Bild nicht geladen werden kann, wird ein Standardhinweis angezeigt
