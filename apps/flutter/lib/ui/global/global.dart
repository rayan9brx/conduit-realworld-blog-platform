...
import 'package:conduit/ui/search_screen/search_screen.dart';
...
class _GlobalScreenState extends State<GlobalScreen> {
  ...
  int? length;
  TextEditingController searchCtrTag = TextEditingController();
  TextEditingController searchCtrKW = TextEditingController();
  @override
  void initState() {
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: ConduitSearchEditText(
                                  ...
                                  controller: searchCtrKW,
                                  readOnly: false,
                                  textInputAction: TextInputAction.search,
                                  onEditingComplete: () {
                                    FocusManager.instance.primaryFocus
                                        ?.unfocus();
                                    if (searchCtrKW.text.length > 0) {
                                      Navigator.pushNamed(
                                        context,
                                        SearchScreen.searchUrl,
                                        arguments: {
                                          'title': searchCtrKW.text,
                                        },
                                      );
                                    };
                                  },
                           ...
                           /* BlocBuilder<SearchBloc, SearchState>(
                            ...
                            Padding(
                              ...
                              child: ConduitSearchEditText(
                                hint: "Search tags",
                                controller: searchCtrTag,
                                readOnly: false,
                                textInputAction: TextInputAction.search,
                                onEditingComplete: () {
                                  FocusManager.instance.primaryFocus?.unfocus();
                                  if (searchCtrTag.text.length > 0) {
                                    Navigator.pushNamed(
                                      context,
                                      TagScreen.tagUrl,
                                      arguments: {
                                        'title': searchCtrTag.text,
                                      },
                                    );
                                  }
                                },
