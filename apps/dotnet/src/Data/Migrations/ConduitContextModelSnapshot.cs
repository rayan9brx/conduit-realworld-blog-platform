// <auto-generated />
// Diese Datei wird automatisch von Entity Framework Core erzeugt und enthält den aktuellen Datenbank-Snapshot.
// Änderungen hier erfolgen über Migrationen im Code, nicht manuell.
...
#pragma warning disable 612, 618
            ...
            //--------------------------------------------------------------------------------------------
            // 1/3  Tabelle zum Speichern mehrerer Bilder pro Artikel
            modelBuilder.Entity("Realworlddotnet.Core.Entities.ArticleImage", b =>
                {
                    ...
                    b.ToTable("ArticleImages"); // Tabellenname in der Datenbank
                });
            //--------------------------------------------------------------------------------------------    
            ...
            //--------------------------------------------------------------------------------------------
            // 2/3 Beziehung zwischen Artikel und Bildern definieren
            modelBuilder.Entity("Realworlddotnet.Core.Entities.ArticleImage", b =>
                {
                    b.HasOne("Realworlddotnet.Core.Entities.Article", "Article")
                        .WithMany("ImageUrls") // Die Navigationseigenschaft im Article-Objekt heißt ImageUrls
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Realworlddotnet.Core.Entities.Article", b =>
                {
                    ...
                    b.Navigation("ImageUrls"); // 3/3 Navigation zu den hochgeladenen Bildern
                });
