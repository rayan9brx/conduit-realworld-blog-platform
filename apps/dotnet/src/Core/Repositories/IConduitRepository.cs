...
public interface IConduitRepository
{
    ...
    public Task<ArticlesResponseDto> GetArticlesAsync(SearchQuery searchQuery, CancellationToken cancellationToken);
    ...
    public Task<IEnumerable<SearchCount>> UpsertKeywordCountsAsync(IEnumerable<string> keywords,
        CancellationToken cancellationToken);
}
